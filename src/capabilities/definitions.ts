...
export const ALL_CAPABILITY_DEFINITIONS: CapabilityDefinition[] = [
  ...
  },
  {
    ...
    description: 'Scan for authenticated accounts (cache-first, cookie-gated)',
  ...
  {
    id: 'get-cached-accounts',
    category: 'core',
    label: 'Get Cached Accounts',
    description: 'Return accounts from IndexedDB without network detection',
  ...
  {
    id: 'ensure-authenticated',
    category: 'core',
    label: 'Ensure Authenticated',
    description: 'Resolve accounts with cache-first, cookie-gated detection',
